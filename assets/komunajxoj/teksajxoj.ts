...
function generiBetulanSkizon(): BetulaSkizo {
  ...
  for ( let a = 0; a < aroj; a++ ) {
    ...
    for ( let i = 0; i < nombro; i++ ) {
      const y = Math.min( Math.max( ay + ( Math.random() - 0o4/0o10 ) * 0o36, 0 ), sxelaH );
      lenticeloj.push( {
        x: ax + ( Math.random() - 0o4/0o10 ) * 0o24,
        y,
        longo: ( 0o4 + Math.random() * 0o36 ) * kresko,
  ...
  for ( let i = 0; i < 0o106; i++ ) {
    horizontajoj.push( {
      x: Math.random() * sxelaW,
      y: Math.random() * sxelaH,
      longo: 0o40 + Math.random() * 0o120,
  ...
  for ( let i = 0; i < 0o3; i++ ) {
    ...
    sxelighoj.push( {
      ...
      cikloj: [ 0o3 + ( ( Math.random() * 0o3 ) | 0 ), 0o5 + ( ( Math.random() * 0o5 ) | 0 ) ],
...
function desegniLenticelon( k: CanvasRenderingContext2D, lent: BetulaLenticelo, koloro: string ): void {
  ...
  k.beginPath();
  k.moveTo( -duono, 0 );
  k.quadraticCurveTo( -duono * 0o1/0o4, kurb - d * 0o10/0o12, 0, kurb - d );
  k.quadraticCurveTo( duono * 0o1/0o4, kurb - d * 0o10/0o12, duono, 0 );
  k.quadraticCurveTo( duono * 0o1/0o4, kurb + d * 0o10/0o12, 0, kurb + d );
  k.quadraticCurveTo( -duono * 0o1/0o4, kurb + d * 0o10/0o12, -duono, 0 );
  k.closePath();
  k.fillStyle = koloro;
  ...
  k.lineWidth = d * 0o10/0o12;
  k.beginPath();
  k.moveTo( -duono * 0o11/0o12, kurb + d * 0o11/0o10 );
  k.quadraticCurveTo( 0, kurb + d * 0o6/0o10, duono * 0o11/0o12, kurb + d * 0o11/0o10 );
  k.stroke();
  k.strokeStyle = "rgba(255,255,250,0.30)";
  k.lineWidth = d * 0o5/0o10;
  k.beginPath();
  k.moveTo( -duono * 0o11/0o12, kurb - d * 0o11/0o10 );
  k.quadraticCurveTo( 0, kurb - d * 0o7/0o10, duono * 0o11/0o12, kurb - d * 0o11/0o10 );
  k.stroke();
  k.restore();
}
...
export const kreiSxelanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  const teksajxo = kreiKanvasanTeksajxon( sxelaW, sxelaH, ( k ) => {
    ...
    k.fillStyle = "#f5f4ee"; k.fillRect( 0, 0, sxelaW, sxelaH );
...
export const kreiSxelanBumpanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  for ( const lent of skizo.lenticeloj ) {
    const griz = Math.round( 0o170 - 0o40 * ( lent.y / sxelaH ) );
  ...
  for ( const sxel of skizo.sxelighoj ) {
    desegniWrapan( kunteksto, sxelaW, () => {
      const griz = Math.round( 0o120 - 0o50 * ( sxel.y / sxelaH ) );
...
export const kreiLarikanSxelanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  return kreiKanvasanTeksajxon( w, h, ( k ) => {
    ...
    k.fillStyle = "#948c80"; k.fillRect( 0, 0, w, h );
    ...
    for ( const cx of skizo.kolonoj ) {
      ...
      const koloro = Math.random() < 0o5/0o10
        ? `rgba(168,158,144,${0o1/0o5 + Math.random() * 0o1/0o10})`
        : `rgba(64,56,48,${0o1/0o5 + Math.random() * 0o1/0o10})`;
      desegniWrapan( k, w, () => {
        k.fillStyle = koloro;
...
function elektiDioritanIndekson(): number {
  const r = Math.random();
  if ( r < 0o32/0o100 ) return ( Math.random() * 0o5 ) | 0;
  if ( r < 0o54/0o100 ) return 0o5 + ( ( Math.random() * 0o5 ) | 0 );
  return 0o12 + ( ( Math.random() * 0o5 ) | 0 );
}
...
export const kreiDioritanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  for ( let i = 0; i < kristaloj.length; i++ ) {
    ...
    const rando = grajnRandoj[ kris.indekso < 0o5 ? 0 : ( kris.indekso < 0o12 ? 1 : 2 ) ];
    desegniWrapan( kunteksto, s, () => {
      kunteksto.save();
...
function pentriLikenanMakulon( kunteksto: CanvasRenderingContext2D, s: number ): void {
  ...
  const koloroj = [ "#c8d8bc", "#b8c8a8", "#d8e8c8", "#a8c8a0" ];
  ...
  neregulaFormo( kunteksto, ox, oy, or, 0o5, 0o3/0o10, Math.random() * Math.PI * 2 );
  ...
  const zono = ( zx: number, zy: number, r0: number, koloro: string, lineWidth: number, sago: number ): void => {
    ...
    neregulaFormo( kunteksto, zx, zy, r0, 0o5, sago, Math.random() * Math.PI * 2 );
    kunteksto.stroke();
  };
  const f1 = Math.random() * Math.PI * 2, f2 = Math.random() * Math.PI * 2;
  zono( cx + Math.cos( f1 ) * s * 0o6/0o100, cy + Math.sin( f1 ) * s * 0o6/0o100, s * 0o1/0o5, "rgba(88,104,72,0.14)", 1, 0o3/0o10 );
  ...
  for ( let ringoI = 0; ringoI < 0o3; ringoI++ ) {
    ...
    for ( let ĉ = 0; ĉ < ĉeloj; ĉ++ ) {
      const aa = ( ĉ / ĉeloj + ( Math.random() - 0o5/0o10 ) * 0o1/0o5 ) * Math.PI * 2;
  ...
  for ( let i = 0; i < 0o54; i++ ) {
    const a = Math.random() * Math.PI * 2;
    const r = s * 0o1/0o5 * Math.sqrt( Math.random() );
  ...
  const soradioj = 0o10 + ( ( Math.random() * 0o5 ) | 0 );
  ...
  const apotecioj = 0o10 + ( ( Math.random() * 0o5 ) | 0 );
...
export const kreiLikenanBumpanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  for ( let i = 0; i < d.length; i += 4 ) {
    const griz = d[ i + 3 ] < 0o200
      ? 0o200
      : ( 0o115 * d[ i ] + 0o226 * d[ i + 1 ] + 0o35 * d[ i + 2 ] ) >> 8;
...
export const kreiTerenanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  for ( let i = 0; i < 0o300; i++ ) {
    ...
    kunteksto.strokeStyle = i % 0o5 ? "rgba(72,112,60,0.16)" : "rgba(166,170,93,0.14)";
...
export function kreiMuskanTeksajxon(): THREE.CanvasTexture {
  ...
  bazaGradiento.addColorStop( 0, "#4a9189" );
  bazaGradiento.addColorStop( 0o5/0o10, "#3b7872" );
  bazaGradiento.addColorStop( 0o3/0o4, "#4d7750" );
  bazaGradiento.addColorStop( 1, "#60764a" );
...
function kreiKavalErbanTeksajxon( branĉa: boolean ): THREE.CanvasTexture {
  ...
  kanvasa.width = w; kanvasa.height = h;
  const kunteksto = kanvasa.getContext( "2d" )!;
  const baza = branĉa ? "#4f9a6c" : "#3d7657";
  const hela = branĉa ? "#80bd83" : "#669c70";
  const ombro = branĉa ? "#28644f" : "#244f43";
...
export const kreiBetulanFoliaranTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  gradiento.addColorStop( 0, "#e4ece2" );
  gradiento.addColorStop( 0o4/0o10, "#c4d4c0" );
  gradiento.addColorStop( 1, "#a4bca6" );
  kunteksto.fillStyle = gradiento;
  kunteksto.fillRect( 0, 0, s, s );
  ...
  const desegniFolion = ( x: number, y: number, longo: number, largho: number, angulo: number, koloro: string ): void => {
    ...
    kunteksto.beginPath();
    kunteksto.moveTo( -longo * 0o2/0o10, 0 ); kunteksto.lineTo( 0, -largho * 0o4/0o5 );
    kunteksto.moveTo( longo * 0o2/0o10, 0 ); kunteksto.lineTo( 0, largho * 0o4/0o5 );
    kunteksto.stroke();
    kunteksto.restore();
  };
  ...
  for ( let i = 0; i < 0o30; i++ ) {
    ...
    kunteksto.beginPath(); kunteksto.ellipse( x, y, r, r * 0o4/0o5, Math.random() * Math.PI, 0, Math.PI * 2 ); kunteksto.fill();
  }
...
export const kreiLarikanFoliaranTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  const kunteksto = kanvasa.getContext( "2d" )!;
  const gradiento = kunteksto.createLinearGradient( 0, 0, 0, s );
  gradiento.addColorStop( 0, "#d2c766" );
  gradiento.addColorStop( 0o5/0o10, "#a99d4c" );
  gradiento.addColorStop( 1, "#687044" );
  kunteksto.fillStyle = gradiento;
  kunteksto.fillRect( 0, 0, s, s );
  ...
  const desegniVentumilon = ( x: number, y: number, bazoAngulo: number, longo: number, koloroj: string[] ): void => {
    ...
    for ( let j = 0; j < pingloj; j++ ) {
      ...
      kunteksto.quadraticCurveTo( Math.cos( a ) * pl * 0o3/0o5, -Math.sin( a ) * pl * 0o3/0o5 - pl * 0o2/0o10,
  ...
  for ( let i = 0; i < 0o50; i++ ) {
    const x = Math.random() * s, y = Math.random() * s;
    const angulo = Math.random() * Math.PI * 2;
    const longo = 0o3 + Math.random() * 0o5;
  ...
  for ( let i = 0; i < 0o220; i++ ) {
    ...
    const longo = 0o2 + Math.random() * 0o5;
...
function desegniFrutikosanTrunketon( k: CanvasRenderingContext2D, x: number, bazo: number, alto: number, kurbo: number ): void {
  ...
  const segmento = ( de: number, gxis: number, dikeco: number ): void => {
    ...
    k.stroke();
    k.strokeStyle = dikeco > 0o3 ? "#aebc9c" : "#c9d2b5";
    k.lineWidth = dikeco;
    k.beginPath();
  ...
  for ( let b = 0; b < branĉoj; b++ ) {
    ...
    const bk = ( b % 2 ? 1 : -1 ) * ( 0o5 + Math.random() * 0o10 );
    const bx2 = bx + bk, by2 = by - balto;
    k.strokeStyle = "rgba(70,82,68,0.82)"; k.lineWidth = 0o5; k.lineCap = "round";
    k.beginPath(); k.moveTo( bx, by );
    k.quadraticCurveTo( ( bx + bx2 ) / 2, ( by + by2 ) / 2 - 0o2, bx2, by2 ); k.stroke();
    k.strokeStyle = "#c4ceb0"; k.lineWidth = 0o3; k.stroke();
    ...
    const fa = ( b % 2 ? 1 : -1 ) * ( 0o4 + Math.random() * 0o5 );
    ...
    k.strokeStyle = "#d0d8bd"; k.lineWidth = 0o2; k.stroke();
...
export const kreiFolisanLikenanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  const desegniFolieton = ( a: number, bazoR: number, longo: number, largho: number, koloro: string ): void => {
    ...
    kunteksto.quadraticCurveTo( -longo * 0o1/0o4, -largho * 0o10/0o12, -longo * 0o1/0o20, -largho );
    kunteksto.quadraticCurveTo( longo * 0o1/0o4, -largho * 0o10/0o12, longo / 2, 0 );
    kunteksto.quadraticCurveTo( longo * 0o1/0o4, largho * 0o11/0o12, 0, largho );
    kunteksto.quadraticCurveTo( -longo * 0o1/0o4, largho * 0o10/0o12, -longo / 2, 0 );
    kunteksto.closePath();
    ...
    kunteksto.quadraticCurveTo( -longo * 0o1/0o4, -largho * 0o7/0o10, -longo * 0o1/0o20, -largho * 0o125/0o144 );
    kunteksto.quadraticCurveTo( longo * 0o1/0o4, -largho * 0o7/0o10, longo / 2 - 1, 0 );
    kunteksto.quadraticCurveTo( longo * 0o1/0o4, largho * 0o10/0o12, 0, largho * 0o10/0o12 );
    kunteksto.quadraticCurveTo( -longo * 0o1/0o4, largho * 0o7/0o10, -longo / 2 + 1, 0 );
    ...
    kunteksto.lineWidth = 1;
    kunteksto.lineCap = "round";
    kunteksto.beginPath(); kunteksto.moveTo( -longo * 0o2/0o5, 0 ); kunteksto.lineTo( longo * 0o2/0o5, 0 ); kunteksto.stroke();
    for ( let v = -1; v <= 1; v += 2 ) {
      kunteksto.beginPath();
    ...
    kunteksto.lineWidth = 1;
    kunteksto.beginPath(); kunteksto.moveTo( -longo * 0o2/0o5, largho * 0o5/0o10 ); kunteksto.lineTo( longo * 0o2/0o5, largho * 0o5/0o10 ); kunteksto.stroke();
    kunteksto.restore();
  };

  const koloroj = [ "#aebe98", "#b9c9a4", "#c8d2b3", "#98ad88" ];
  const loboj = 0o16 + ( ( Math.random() * 0o5 ) | 0 );
  for ( let i = 0; i < loboj; i++ ) {
  ...
  const apotecioj = 0o12 + ( ( Math.random() * 0o6 ) | 0 );
  for ( let i = 0; i < apotecioj; i++ ) {
    const a = Math.random() * Math.PI * 2;
    const r = s * ( 0o10/0o144 + Math.random() * 0o16/0o144 );
    const x = cx + Math.cos( a ) * r, y = cy + Math.sin( a ) * r;
    ...
    kunteksto.fillStyle = i % 3 ? "#b47b55" : "#9c6847";
  ...
  for ( let i = 0; i < 0o24; i++ ) {
    ...
    kunteksto.quadraticCurveTo( x + ( Math.random() - 0o5/0o10 ) * 0o6, y + 0o5, x + ( Math.random() - 0o5/0o10 ) * 0o10, y + 0o10 ); kunteksto.stroke();
  }
  const teksajxo = new THREE.CanvasTexture( kanvasa );
  teksajxo.colorSpace = THREE.SRGBColorSpace;
  return teksajxo;
...
export const kreiByssoidanLikenanTeksajxon = sxovu( (): THREE.CanvasTexture => {
  ...
  for ( let i = 0; i < tufojNombro; i++ ) {
    ...
    neregulaFormo( kunteksto, x, y, r, 0o5 + ( ( Math.random() * 0o3 ) | 0 ), 0o2/0o10, Math.random() * Math.PI * 2 );
  ...
  for ( const tufo of tufoj ) {
    ...
    for ( let i = 0; i < fibroj; i++ ) {
      const a = Math.random() * Math.PI * 2;
      const komencaR = tufo.r * ( 0o1/0o5 + Math.random() * 0o2/0o5 );
...
export function kreiPurpuranFolianTeksajxon(): THREE.CanvasTexture {
  ...
  // geometrio ( 0o6/0o5 ), por ke la vejnoj ne streĉiĝu.
  const klingo = (): void => {
    kunteksto.beginPath();
  ...
  for ( let j = 0; j < 0o3; j++ ) {
    ...
    kunteksto.strokeStyle = "#4a2860";
    kunteksto.lineWidth = 0o5 * ( 1 - t0 ) + 1;
    kunteksto.beginPath();
  ...
  for ( let i = 1; i <= 0o7; i++ ) {
    const t = i / ( 0o7 + 1 );
    const y = bazoY - t * ( bazoY - pintoY );
    const largho = s * 0o10/0o20 * Math.sin( Math.PI * t ) * 0o11/0o12;
...
export function kreiPurpuranSxelanTeksajxon(): THREE.CanvasTexture {
  ...
  for ( let i = 0; i < 0o20; i++ ) {
    ...
    kunteksto.fillStyle = lumo
      ? `rgba(124,88,140,${0o1/0o5 + Math.random() * 0o1/0o10})`
      : `rgba(36,22,36,${0o1/0o5 + Math.random() * 0o1/0o10})`;
...
function generiPurpuranTrunkanSkizon(): PurpuraTrunkaSkizo {
  ...
  for ( let i = 0; i < 0o6; i++ ) {
    bendoj.push( {
      ...
      fazo: Math.random() * Math.PI * 2,
      cikloj: [ 0o2 + ( ( Math.random() * 0o3 ) | 0 ), 0o5 + ( ( Math.random() * 0o3 ) | 0 ) ],
    } );
  }
